...
app.conf.broker_url = os.getenv('CELERY_BROKER_URL', os.getenv('REDIS_URL', 'redis://127.0.0.1:6379/0'))
app.conf.result_backend = os.getenv('CELERY_RESULT_BACKEND', os.getenv('REDIS_URL', app.conf.broker_url))
