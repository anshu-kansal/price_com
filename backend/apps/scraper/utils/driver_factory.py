...
class WebDriverFactory:
    ...
    # To enable production proxy rotation:
    # 1. Set PROXY_URLS in .env as comma-separated list:
    #    PROXY_URLS=http://user:pass@proxy1:8080,http://user:pass@proxy2:8080
    # 2. For residential proxies (recommended for Amazon/Flipkart):
    #    - BrightData (https://brightdata.com) - best evasion
    #    - Oxylabs (https://oxylabs.io) - good for India
    #    - SmartProxy (https://smartproxy.com) - budget option
    # 3. For rotating datacenter proxies:
    #    - Use a single gateway URL with session-based rotation
    #    - Example: http://user:pass@gate.smartproxy.com:7777
    # ────────────────────────────────────────────────────────────────
